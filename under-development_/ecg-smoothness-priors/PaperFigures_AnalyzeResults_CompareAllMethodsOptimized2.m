...
% end
figure(1);
plot(snr_list, squeeze(snrimp_mean_WAVELET(scal_opt_WAVELET, wname_opt_WAVELET, :)), 'k', 'marker', 'square', 'LineWidth', 3, 'MarkerEdgeColor','k', 'MarkerFaceColor', 'k', 'MarkerSize', 4);
grid
...
% end
figure(2);
plot(snr_list, squeeze(snrimp_std_WAVELET(scal_opt_WAVELET, wname_opt_WAVELET, :)), 'k', 'marker', 'square', 'LineWidth', 3, 'MarkerEdgeColor','k', 'MarkerFaceColor', 'k', 'MarkerSize', 4);
grid
