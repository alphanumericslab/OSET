...
[x_filtered1, x_filtered2, optim_gammas1, optim_gammas2] = ECGSmoothnessPriorsDenoiserBW(x, 1e-2, mode, DiffOrder, round(wlen*fs), 1e-8, 250, 1);
...
plot(tt, x_filtered2, 'r', 'linewidth', 3);
set(gca, 'fontsize', 16);
