...
R_f1 = rotation_matrix_3d(-3*pi/4,0,-pi/2);     % fetal rotation matrices (tetax,tetay,tetaz)
Lambda_f1 = eye(3);
...
R_f2 = rotation_matrix_3d(3*pi/4,pi/20,-pi/2.5);     % fetal rotation matrices (tetax,tetay,tetaz)
Lambda_f2 = eye(3);
...
[DIP_f1, teta_f1] = vcg_gen_direct_sum(N,fs,F_f1,alphai_f1,bi_f1,tetai_f1,teta0_f1);
[DIP_f2, teta_f2] = vcg_gen_direct_sum(N,fs,F_f2,alphai_f2,bi_f2,tetai_f2,teta0_f2);
