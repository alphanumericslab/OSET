% test ECG PCA, ICA, PiCA plots after component removal
%
...
for i = 1:size(s,1)
    ...
    if(mod(i,L)==0 || i==size(s,1))
        xlabel('Time (s)','FontSize',16);
        set(h,'PaperUnits','inches');
        set(h,'PaperPosition',[.01 .01 3.5 6.4])
