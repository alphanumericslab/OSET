function [baseline, bl1, bl2, bl3] = baseline_filter(x_raw, baseline_removal_method, params)
...
switch baseline_removal_method
    ...
    case 'MD->MD->MD->MN' % Three median filters followed by a moving average
        bl1 = baseline_sliding_window(x_raw, params.wlen1, 'md');
        bl2 = baseline_sliding_window(bl1, params.wlen2, 'md');
        bl3 = baseline_sliding_window(bl2, params.wlen3, 'md');
        baseline = baseline_sliding_window(bl3, params.wlen4, 'mn');
