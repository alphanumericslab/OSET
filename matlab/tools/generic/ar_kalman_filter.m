function [y_kf_prior, y_kf_post, y_ks, P_kf_prior, P_kf_post, P_ks, kf_gain, eta, y_kf_pred, P_kf_pred] = ar_kalman_filter(y, b, a, varargin)
% ar_kalman_filter - Removing lowpass noise using a first order linear Kalman filter and smoother.
%
% Syntax: [y_kf_prior, y_kf_post, y_ks, P_kf_prior, P_kf_post, P_ks, kf_gain, eta, y_kf_pred, P_kf_pred] = ar_kalman_filter(y, b, a, q, r, gamma, wlen, mode, predict_forward)
%
% Inputs:
