% *************************************************************************
% * Test program for Instantaneous Phase estimation using the Zer-pole    *
% * Perturbation Phase estimation method (Z-PPP) [1] through analytic     *
...
max_f = 30;                          % frequencies of interest
WS = 1;                              % Stop-band frequency (Hz)
fs = 173.61;                         % sampling frequency
pertnum = 100;
tt = (0:n-1)/fs;
ff = 1:max_f;
[phase, inst_freq, amp] = Phase_Ex_ZPPP(sig, fs, [], max_f, [], pertnum);
