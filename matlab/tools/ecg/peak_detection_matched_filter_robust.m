function [peaks, r] = peak_detection_matched_filter_robust(ref, fs, h, fmax, varargin)
...
% Use peak_detection_local_search function to detect peaks
peaks = peak_detection_local_search(r, fmax/fs, 1, itr);
