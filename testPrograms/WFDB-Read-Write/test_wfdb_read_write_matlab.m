...
isquant = 1;
isdigital = 1;
mat2wfdb(double(signal_quant)', [fname, '_mat2wfdb_digital'], sampling_rate, bit_res, adu, info, gains, channel_names, baseline, isquant, isdigital);
...
gains2 = [];
baseline2 = [];
mat2wfdb(double(signal)', [fname, '_mat2wfdb'], sampling_rate, bit_res, adu, info, gains2, channel_names, baseline2, isquant2, isdigital2);
