function [PeakToPeak_corrected, PeakToPeak_differences, matched_peaks_indexes, smoothed_matched_output] = MFPeakDetector2(x, matched_template, type,  wlen, PP_diff_wlen, PP_diff_th, average_peak_detection_rate, fs, plotflag)
% ===========================================================
