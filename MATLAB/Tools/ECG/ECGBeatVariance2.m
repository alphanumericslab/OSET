...
%
% [ECGmean, ECGsd] = ECGBeatVariance2(x, peaks, wlen)
% Calculation of the mean and SD of ECG waveforms in different beats after
% making the R-peaks equal in amplitude
%
% inputs:
% x: input ECG signal
% peaks: ECG peaks
...
ECG = zeros(N,2*wlen);
for i = 1 : N,
    ECG(i,:) = x(I(i)-wlen+1:I(i)+wlen) - x(I(i));
end
