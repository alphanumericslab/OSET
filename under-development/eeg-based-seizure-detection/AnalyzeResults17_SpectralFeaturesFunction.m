function AnalyzeResults17_SpectralFeaturesFunction(Rdata, Rtextdata, outputfileame1, outputfileame2, per_subject)
% close all;
% % parameters
...
for s = 1:max_subject,
    ...
    classifier_type = 'quadratic';
   [class2, err2, scores, logp2, coeff2] = classify(r, r(train_indexes, :), types(train_indexes), classifier_type);
