...
function [pi_0_lsim , coupling_tetha_IM , transition_matrices_IM ,  gmm_para_lsim ,  AIC, log_likelyhood, BIC, pi_steady] = em_lsim_fast( channels_observations , channel_num_states , num_gmm_component , max_itration , extra)
        ...
        for i = 1:channel_num_states(zee)
            ...
            for k = 1:num_gmm_component(zee)
                ...
                if sigma_diag
                    ...
                    sigma_all_new( dimension_numbers_index(zee)+1:dimension_numbers_index(zee+1), 1:dim_observation(zee), i , k) = (sig_temp+sig_temp')/2;
                end
